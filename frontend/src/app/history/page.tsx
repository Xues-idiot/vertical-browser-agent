          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-between">
            ...
            <div className="relative max-w-md w-full">
              <input
                ...
                className="w-full bg-[#1F2937] border border-gray-700 rounded-lg px-4 py-2 pl-10 text-gray-100 placeholder-gray-500 focus:outline-none focus:border-cyan-500"
              />
